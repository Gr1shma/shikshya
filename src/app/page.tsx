...
import ProductDemo from "~/modules/home/ui/product-demo";
import ProductFeatures from "~/modules/home/ui/product-features";
...
const HomePage = () => {
    return (
        <div>
            <HeroSection />
            <div className="mt-11 flex flex-col items-center justify-center gap-4 pb-64 sm:flex-row">
                <Link
                    href="/course"
